...
public class PositionInfo : INotifyPropertyChanged
{
    ...
    private decimal _marginType;
    private decimal _isolatedMargin;
    private bool _isAutoAddMargin;
    private decimal _notional;
    private decimal _isolatedWallet;
    private decimal _updateTime;
    ...
    public decimal IsolatedMargin
    {
        ...
        set
        {
            if (_isolatedMargin != value)
            {
                _isolatedMargin = value;
                OnPropertyChanged(nameof(IsolatedMargin));
            }
        }
    }
    ...
    public decimal IsolatedWallet
    {
        ...
        set
        {
            if (_isolatedWallet != value)
            {
                _isolatedWallet = value;
                OnPropertyChanged(nameof(IsolatedWallet));
            }
        }
    }

    public decimal UpdateTime
    {
        get => _updateTime;
        set
        {
